...
category: account
order: 1
tags: "identity, apple account, apple id, icloud, sign in, switch, new phone, device, adult"
quick: "Team Assist uses the Apple Account already on your iPhone, plus a one-time confirmation that you're 18 or over. Your information follows that account, not the device."
related:
  - who-can-use
  - no-account
  - privacy-and-data
...
**The age confirmation.** You confirm once that you're 18 or over. On iOS 26 and later
Apple handles that confirmation; on earlier versions you confirm it yourself. If you
decline Apple's check, or indicate you're under 18, the app won't open. Nothing you've
already put in is lost while the confirmation is outstanding.
